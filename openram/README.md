...
1.4 V/100 C Liberty corners used by the synthesis and STA flows. The required
spare row makes the generated physical address bus 11 bits; retroSoC ties its
high bit low to expose exactly logical words 0 through 1023.
